...
fn run_files(o: &CliOpts) -> i32 {
    ...
    for f in &o.files {
        ...
        // بلا قيمة — فالفتحة هنا سيمافور نواة يراه التطبيق أيضاً.
        //
        // والسطر التالي يُطبع **قبل** نداء الفتحة: انتظار الفتحة كان صامتاً
        // تماماً (قاس المدقّق 342 ثانية بلا سطر واحد)، وCLI لا يملك طريقة
        // صادقة ليعرف أن الرمزين محجوزان قبل أن يحجزهما (كائنا نواة يعبران
        // العمليات)، فيُطبع دائماً بدل تخمين الحالة.
        eprintln!("بانتظار فتحة فصل…");
