 ...
 *
 * **و`engine` لم يعد منها** (جولة settings2 الرابعة): كان يحمل `#cuda-provider`
 * و`#max-jobs` (نُقلا إلى `performance`)، ثم `#keep-inst` و`#fmt-select` (أُعيدا
 * إلى اللوحة المتقدّمة خلف ٦ نقرات بقرار المالك) ⇒ **صار بلا أي معرّف**، وتبويبٌ
 * فارغ عطبٌ لا تبسيط. فحُذف التبويب (زرّه وحاويته وتسميته) بدل تركه فارغاً.
 * **وحارسه**: «لا تبويب بلا معرّف» في `src/__tests__/settingsTabs.test.ts`. */
