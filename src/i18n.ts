...
const i18n = {
  ar: {
    ...
    max_jobs_hint: '2 أسرع عند فصل ملفين معاً (وهو سقف ذاكرة الكرت) · 1 أخفّ على الجهاز لمن يعتمد على المعالج.',
  ...
  en: {
    ...
    max_jobs_hint: '2 is faster when two files are separated at once (that is the GPU memory ceiling) · 1 is lighter, for CPU-bound machines.',
