...
const I18N = {
  ...
  en: {
    ...
    'offline.step3': 'Reopen this popup to connect to the bridge right away.',
    'target.label': 'Current active tab:',
    'mode.clip.title': 'Clip mode',
    'mode.clip.desc': 'Remove the music only — keeps the dialogue clean',
    ...
    'send.unsendable': 'This page cannot be sent — open a video page or a regular web page.',
    ...
    'yt.title': 'Note:',
    'yt.body': 'The inline controls (process this video / watch without music) are added automatically to YouTube’s player bar.',
