...
**ويندوز فقط حتى 1.0** — لا نسخة لماك أو لينكس.  
...
الوثيقة الرسمية لهذا المستودع هي **[README.md](README.md)** — وهي **بالإنجليزية**، ويعرضها
GitHub في الصفحة الأولى. وهذا الملف هو **النسخة العربية** منها، بنبرة العلامة كما هي.
