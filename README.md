...
- **مشاهدة مفلترة في المتصفح:** صارت **تتخطّى فترات الصمت** الناتجة عن كتم الموسيقى (قفز الفيديو فوقها فوراً) بدل تشغيلها، مع خيار في قائمة الزر الأيمن يوقف التخطي.
...
- **إضافة المتصفح:** أرسل أي رابط فيديو بنقرة يمين إلى التطبيق — والمعالجة كاملةً تبقى على جهازك. ويمكن **مشاهدة الفيديو بعد الفلترة** داخل الصفحة (الصوت من المعالجة المحلية مع تخطي فترات الصمت).
