...
> `store-assets/` (خارج git). الإصدار المرفوع: **1.1.0** من
> `src-tauri/target/store/HaramLite-Bridge-1.1.0.zip`.
...
1. [ ] رفع `HaramLite-Bridge-1.1.0.zip` (المانيفست في الجذر، الإصدار 1.1.0 > المنشور 1.0.15).
