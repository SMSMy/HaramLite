...
|---|---|---|---|---|
| ١ | اختبارات Rust | `cargo test --quiet` | **١٧٠ ناجحاً + ٣ مُهمَل** من ١٧٣ (مقيس 2026-09-15 بـ`cargo test --lib`): الفصل بالنموذج الحقيقي · الوسائط · الإعدادات · الجسر · ٦ اختبارات لحالات CUDA · واختبارا E2E (أحدهما `#[ignore]` يحتاج ffmpeg) | `ci.yml:74-76` |
