...
|---|---|---|---|---|
| ١ | اختبارات Rust | `cargo test --quiet` | **١٦٤ ناجحاً + ٣ مُهمَل** من ١٦٧ (مقيس 2026-09-15 بـ`cargo test --lib`): الفصل بالنموذج الحقيقي · الوسائط · الإعدادات · الجسر · واختبارا E2E (أحدهما `#[ignore]` يحتاج ffmpeg) | `ci.yml:74-76` |
